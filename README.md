...
npx tsc prisma/seed.ts --outDir dist && node dist/seed.js
```
Para comprobar qeu todo es correcto, lanza desde consola: npx prisma studio

y comprueba que las tablas/modelos tienen datos.
